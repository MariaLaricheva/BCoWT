...
namespace LINQ_Basics
{
    ...
    class Program
    {
        ...
        {
            new Employee(1, "Антонов", 3),
            new Employee(2, "Александров", 3),
            new Employee(3, "Зяблицева", 2),
            new Employee(4, "Арчакова", 1),
            new Employee(5, "Артемьева", 4),
            new Employee(6, "Давыдов", 3),
            new Employee(7, "Пискарёв", 2),
            new Employee(8, "Беспалов", 1),
            new Employee(9, "Алексеев", 3),
